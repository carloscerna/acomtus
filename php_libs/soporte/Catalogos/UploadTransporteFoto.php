    ...
    if (($_FILES["file"]["type"] == "image/pjpeg")
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $path_root . $url_ .$_FILES['file']['name'])) {
            ...
            // Ejecutamos el query
                ...
                {
                    $nombreArchivo = trim($listado['foto_transporte']);
            ...
            // Capturar nombre temporal.
                ...
                $nombreArchivo = "foto-".$id_."-".$random.".".$extension;
            ...
            // Armar query. para actualizar el nombre del archivo de la ruta foto.
                $query = "UPDATE transporte_colectivo SET foto_transporte = '".$nombreArchivo."' WHERE id_ = ". $id_;
            // Ejecutamos el Query.
